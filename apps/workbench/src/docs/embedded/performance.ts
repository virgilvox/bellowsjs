...
A build matrix proves that code is valid for a part and fits in its memory. It says nothing about keeping up. Every cell of the board matrix in [examples/README.md](https://github.com/virgilvox/bellowsjs/blob/main/packages/bellows-embedded/examples/README.md) is a link, not a run.
