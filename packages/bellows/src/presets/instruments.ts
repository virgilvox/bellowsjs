...
export const INSTRUMENT_PRESETS: InstrumentPreset[] = [
  ...
  /* ---------------------------------------------------------------- */
  {
    ...
    family: 'strings',
    engineId: 'string',
    // fixed violin body (bodySize 0), light fast bow, expressive vibrato
    params: {
      damp: 0.18,
      sustain: 0.85,
      dispersion: 0,
  ...
  },
  {
    ...
    family: 'strings',
    engineId: 'string',
    // undersized body: nasal mid formant, slightly slower vibrato
    params: {
      damp: 0.28,
      sustain: 0.85,
      dispersion: 0,
  ...
  },
  {
    ...
    family: 'strings',
    engineId: 'string',
    // wood modes down near 175 to 220 Hz, firmer slower bow
    params: {
      damp: 0.38,
      sustain: 0.9,
      dispersion: 0,
  ...
  },
  {
    ...
    family: 'strings',
    engineId: 'string',
    // bowed arco bass: weak radiated fundamental, growl from the
    // 250 Hz to 1 kHz modes, slow narrow vibrato
    params: {
      damp: 0.5,
      sustain: 0.9,
      dispersion: 0.05,
  ...
  },
  {
    ...
    family: 'strings',
    engineId: 'string',
    // plucked, but through the body bank: no bow, no vibrato
    params: { damp: 0.45, sustain: 0.3, dispersion: 0, bow: 0, body: 0.6, bodySize: 0.3, level: 0.9 },
    gain: 1,
  },
